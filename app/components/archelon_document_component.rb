class ArchelonDocumentComponent < Blacklight::Component
  ...
  # UMD Customization: As of checking it's version 3.12.1
  # Setting it without the check because in production it can't find the component
  COLLECTION_INDEX_OFFSET = 1
  ...
  # The document title, adjusting for the name of the title
